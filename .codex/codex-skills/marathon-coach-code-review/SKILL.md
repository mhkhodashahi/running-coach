...
- LLM workflows: keep schemas, prompts, normalization, and fallback payloads aligned.
...
- Garmin sync/import: avoid breaking activity IDs, GPS points, laps/splits, token handling, or mock-data fallback.
